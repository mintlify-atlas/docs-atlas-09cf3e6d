---
title: "BestClient Configuration Variables: Quick Reference"
...
- **[Visuals](/config/visuals)** — Camera, particles, tee effects, media backgrounds, music player, optimizer, focus mode, and animations
...
- **[HUD](/config/hud)** — Module positions, scale, speedrun timer, finish prediction, and HUD visibility
